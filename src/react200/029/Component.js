...
class ShallowEqual extends Component {
    ...
    componentDidMount() {
        ...
        console.log(`shallowEqualArrays(Arrays1, Array2): ${shallowEqualArrays(Array1, Array2)}`);
        console.log(`shallowEqualArrays(Arrays2, Array3): ${shallowEqualArrays(Array2, Array3)}`);
